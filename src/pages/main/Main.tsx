...
import {
    isChattingOpenHandler,
    isTerminalOpenHandler,
} from '@/store/reducers/uiControlSlice';
        ...
        <div className="h-full w-full text-white relative">
            {isSignupModalOpen && (
                <SignupModal
                    ...
                    setIsSignupSuccessOpen={setIsSignupSuccessOpen}
                />
            )}
            {isSignupSuccessOpen && (
                <SignupSuccess
            ...
            {isMyProfileOpen && (
                <MyProfile setIsMyProfileOpen={setIsMyProfileOpen} />
            )}
            {isTreeRightClick && (
                <TreeRightClick
            ...
            >
                ...
                <div className="flex h-full flex-grow  px-[10px] items-center text-white text-sm scrollbar-hide ">
                    ...
                    >
                        파일
                        {isFileMenuOpen && (
                            <FileMenu selectedFile={selectedFile} />
                        )}
                    </div>
                    <div className=" cursor-pointer customhover h-full flex justify-center items-center px-[10px]">
                        보기
                    </div>
                    <div className=" cursor-pointer customhover h-full flex justify-center items-center px-[10px]">
                        실행
            ...
            >
                <div
                    className="w-[237px]  h-full"
                    style={{ borderRight: 'solid 1px #141617' }}
                >
                    <div
            ...
            "
                    ...
                    >
                        ...
                        <div
                            style={{
                                height: `calc(100% - ${myTreeViewRef.current?.clientHeight})`,
                            }}
                            onClick={() => {
                                ...
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        window.open(
                                            '/pagechatroom',
                                            '_blank',
                                            `height=${window.screen.height},width=500`,
                                        );
                                    }}
                                >
                                    open_in_new
